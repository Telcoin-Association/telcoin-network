...
impl BlsPublicKey {
    ...
    ///
    /// Unlike [`Self::from_literal_bytes`] (which expects the 96-byte compressed form), this accepts
    /// the uncompressed bytes the protocol passes to the on-chain `BlsG1` library. Used by the
