    ...
    Pool: TransactionPool,
{
    ...
    while let Some(pool_tx) = best_txs.next() {
        ...
        if cumulative_gas_used + pool_tx.gas_limit() > gas_limit {
        ...
        //
        // TODO: ensure tx size is less than max worker block size (in bytes)
        //
...
// #[inline]
// pub fn build_worker_block_full<EvmConfig, Pool, Provider>(
