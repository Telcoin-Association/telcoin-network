...
/// Half of the secp256k1 curve order, used to check for signature malleability.
...
pub(crate) fn handle_domain_separator(gas_limit: u64, chain_id: u64) -> PrecompileResult {
