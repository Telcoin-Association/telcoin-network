//! Node record schema and domain-separated BLS signatures.

use crate::{NetworkType, RpcInfo};
use libp2p::Multiaddr;
use serde::{Deserialize, Serialize};
use tn_types::{
    encode, now, try_decode, BlsPublicKey, BlsSignature, NetworkPublicKey, TimestampSec, WorkerId,
};
