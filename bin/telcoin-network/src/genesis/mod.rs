...
use crate::args::{clap_address_parser, clap_u256_parser, maybe_hex};
...
impl GenesisArgs {
    ...
    pub fn execute(&self) -> eyre::Result<()> {
        ...
        let itel_balance = clap_u256_parser("100_000_000_000")? - genesis_stake;
